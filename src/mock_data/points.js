export const POINTS = [
  ...
  export const dataSchedule = [
    [ { subject : 'Chào cờ',note : null },
      { subject : 'Văn học',note : 'Xin chao' },
      { subject : 'Toán học',note : null },
      { subject : 'Lịch sử',note : null },
      { subject : 'Địa lý',note : null },
      { subject : 'Mỹ thuật',note : null }
    ],
    [ { subject : 'Chào cờ',note : 'Xin chao' },
      { subject : 'Văn học',note : null},
      { subject : 'Toán học',note : null },
      { subject : 'Lịch sử',note : null },
      { subject : 'Địa lý',note : 'Xin chao' },
      { subject : 'Hoá học',note : null }
    ],
    [ { subject : 'Chào cờ',note : null },
      { subject : 'Văn học',note : null },
      { subject : 'Toán học',note : 'Xin chao' },
      { subject : 'Lịch sử',note : null },
      { subject : 'Địa lý',note : 'Xin chao' },
      { subject : '',note : null }
    ],
    ...
    [ { subject : 'Chào cờ',note : null },
      { subject : 'Văn học',note : 'Xin chao' },
      { subject : 'Toán học',note : null },
      { subject : 'Lịch sử',note : 'Xin chao' },
      { subject : 'Địa lý',note : null },
      { subject : 'Sinh học',note : 'Xin chao' }
    ],
